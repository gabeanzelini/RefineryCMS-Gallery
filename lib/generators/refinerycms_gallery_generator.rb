...
class RefinerycmsGalleryGenerator < Rails::Generators::NamedBase
  include Rails::Generators::Migration

  source_root File.expand_path('../refinerycms_gallery/templates/', __FILE__)
  argument :name, :type => :string, :default => 'photo', :banner => ''
  argument :attributes, :type => :array, :default => ["name:string", "gallery_name:string", "image_id:integer"]

  def generate
    # seed file
    template 'db/seeds/seed.rb', Rails.root.join('db/seeds/refinerycms_gallery.rb')
